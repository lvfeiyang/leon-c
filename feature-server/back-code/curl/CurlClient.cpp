...
void CurlClient::initializeSsl(const string& caPath, const string& nextProtos,
  ...
  folly::splitTo<string>(',', nextProtos,
                         std::inserter(nextProtoList, nextProtoList.begin()));
